    ...
    <SignedIn>
      <div className="">
        <div className="dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex h-[10rem] w-full items-center justify-center bg-white dark:bg-black">
          ...
          <h2 className="primary relative z-20 mt-12 py-8 bg-gradient-to-b from-neutral-400 to-neutral-700 bg-clip-text text-center text-5xl font-bold text-transparent">
            Annotation History
          </h2>
        </div>
        <Table>
